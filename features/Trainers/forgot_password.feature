...
#      | Trainer Licence Number | Please provide a username.       |
...
#    And I click "Forgot Your Password?"
#    And I will be directed to "Forgot your password?" page
#    When I enter valid "Trainer Licence Number"
...
#    And I click "Forgot Your Password?"
#    And I will be directed to "Forgot your password?" page
#    When I enter "<Matching Trainer Licence Number>" as "Trainer Licence Number"
...
#
#    Examples:
#      | Matching Trainer Licence Number | Non Matching Email |
...
#    And I click "Forgot Your Password?"
#    And I will be directed to "Forgot your password?" page
#    When I enter "<Non Matching Trainer Licence Number>" as "Trainer Licence Number"
...
#
#    Examples:
#      | Non Matching Trainer Licence Number | Matching Email        |
...
#    And I click "Forgot Your Password?"
#    And I will be directed to "Forgot your password?" page
#    When I enter "<Matching Username>" as "Trainer Licence Number"
#    And I enter "<Matching Email>" as "Email"
#    And I click "Reset Password"
#    And I will be re-directed to login page
#    Then I should see the message as "If the details you entered are correct, you will receive an email shortly with instructions to reset your password. If you do not receive the email, try requesting a password reset again using the 'Forgot Your Password?' feature. Alternatively, you can contact your local administrator or Support Desk."
#
#    Examples:
#      | Matching Trainer Licence Number | Matching Email        |
...
#    Examples:
#
#      | Matching Trainer Licence Number | Matching Email        | Subject               | Email Body                                                                                                                                                                                                                                     |
...
#
#  @changed_assessor_pwd_within_24_hrs @nologout  @DR-1126
...
#    And I enter Trainer Licence Number
#    And  I enter Email
...
#
#
#  @multiple_emails_reset_pwd_not_allowed @nologout @DR-1126
#  Scenario: Verify the emails when trainer reset password is changed multiple times within 24 hours
#    And I login as an "Compliance Manager"
#    And I navigate to "TRAINERS" page
#    And I fill Mandatory fields with required details on create trainer form
#    And I click "Create Trainer"
